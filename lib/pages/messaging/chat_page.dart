...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.peerAvatar, @required this.peerUserName}) : super(key: key);
...
class ChatScreenState extends State<ChatScreen> {
  ...
  void onSendMessage(String content, int type) {
    ...
    if (content.trim() != '') {
      ...
      Firestore.instance.collection('insta_users').document(currentUserModel.id).setData({'chattingWith': {peerId:true}},merge: true);
      Firestore.instance.collection('insta_users').document(peerId).setData({'chattingWith': {currentUserModel.id:true}},merge: true);
