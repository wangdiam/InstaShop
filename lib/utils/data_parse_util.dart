...
//      return User(username: name, id: userID, photoUrl: imageUrl);
//    } catch (e) {
//      return User(username: UNDEFINED, id: UNDEFINED, photoUrl: UNDEFINED);
//    }
//  }
//
...
//        likedUsers.add(User(id: map[key]["userID"], username: map[key]["name"]));
//      });
//      return likedUsers;
//    }
//  }
